...
int send_sftp_create_v03(struct sftp_client_s *sftp, struct sftp_request_s *sftp_r)
{
...
int send_sftp_extension_v03(struct sftp_client_s *sftp, struct sftp_request_s *sftp_r)
{
    ...
    logoutput_debug("send_sftp_extension_v03: name %.*s", len, sftp_r->call.extension.id.name.name);
...
int send_sftp_custom_v03(struct sftp_client_s *sftp, struct sftp_request_s *sftp_r)
{
    ...
    logoutput_debug("send_sftp_custom_v03: nr %i", sftp_r->call.extension.id.nr);
