...
#ifndef _SFTP_ATTR_WRITE_ATTR_V03_H
#define _SFTP_ATTR_WRITE_ATTR_V03_H

/* prototypes */

typedef void (* write_attr_cb)(struct sftp_client_s *sftp, struct attr_buffer_s *buffer, struct sftp_attr_s *attr, unsigned int *valid);
