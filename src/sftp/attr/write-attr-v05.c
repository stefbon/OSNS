...
void write_attr_accesstime_v05(struct sftp_client_s *sftp, struct attr_buffer_s *buffer, struct sftp_attr_s *attr, unsigned int *valid)
{
    ...
    *valid|=SSH_FILEXFER_ATTR_ACCESSTIME;
    ...
    if (sftp->supported.version.v05.attribute_mask & SSH_FILEXFER_ATTR_SUBSECOND_TIMES) {

	store_uint32((char *) (buffer->pos), attr->atime_n);
...
static write_attr_cb write_attr_acb[][2] = {
	...
	{write_attr_zero, write_attr_accesstime_v05},
	{write_attr_zero, write_attr_modifytime_v05},
	{write_attr_zero, write_attr_changetime_v05}};
