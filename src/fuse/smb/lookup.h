...
#ifndef _FUSE_SMB_LOOKUP_H
#define _FUSE_SMB_LOOKUP_H

void _fs_smb_lookup_new(struct service_context_s *c, struct fuse_request_s *r, struct inode_s *inode, struct name_s *xname, struct pathinfo_s *pathinfo);
void _fs_smb_lookup_existing(struct service_context_s *c, struct fuse_request_s *r, struct entry_s *entry, struct pathinfo_s *pathinfo);
