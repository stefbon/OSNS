...
#ifndef _FUSE_SFTP_OPENDIR_H
#define _FUSE_SFTP_OPENDIR_H

void _fs_sftp_opendir(struct fuse_opendir_s *opendir, struct fuse_request_s *r, struct fuse_path_s *fpath, unsigned int flags);
...
void _fs_sftp_opendir_disconnected(struct fuse_opendir_s *opendir, struct fuse_request_s *f_request, struct fuse_path_s *fpath, unsigned int flags);
