...
void _fs_sftp_create(struct fuse_openfile_s *openfile,struct fuse_request_s *f, struct pathinfo_s *pathinfo, struct system_stat_s *stat, unsigned int flags);
...
void _fs_sftp_create_disconnected(struct fuse_openfile_s *openfile, struct fuse_request_s *f_request, struct pathinfo_s *pathinfo, struct system_stat_s *st, unsigned int flags);
