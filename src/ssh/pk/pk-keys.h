...
struct ssh_key_s {
    ...
    int 				(* sign)(struct ssh_key_s *key, unsigned char *b, unsigned int size, struct ssh_string_s *sig, const char *hashname);
    int					(* verify)(struct ssh_key_s *key, unsigned char *b, unsigned int size, struct ssh_string_s *sig, const char *hashname);
