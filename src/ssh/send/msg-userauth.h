...
int send_userauth_pubkey_message(struct ssh_connection_s *c, struct ssh_string_s *s_username, struct ssh_string_s *service, struct ssh_key_s *pkey, struct ssh_string_s *sig, uint32_t *seq);
...
int send_userauth_none_message(struct ssh_connection_s *c, struct ssh_string_s *user, struct ssh_string_s *service, uint32_t *seq);
...
int send_userauth_hostbased_message(struct ssh_connection_s *c, struct ssh_string_s *s_u, struct ssh_string_s *service, struct ssh_key_s *key, struct ssh_string_s *c_h, struct ssh_string_s *c_u, struct ssh_string_s *signature, uint32_t *seq);

/* password - client */

int send_userauth_password_message(struct ssh_connection_s *c, char *user, char *pw, struct ssh_string_s *service, uint32_t *seq);
