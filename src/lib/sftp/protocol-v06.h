...
#ifndef LIB_SFTP_PROTOCOL_V06_H
#define LIB_SFTP_PROTOCOL_V06_H
...
#define SSH_FILEXFER_ATTR_ALLOCATION_SIZE	1 << SSH_FILEXFER_INDEX_ALLOCATION_SIZE
#define SSH_FILEXFER_ATTR_TEXT_HINT		1 << SSH_FILEXFER_INDEX_TEXT_HINT
#define SSH_FILEXFER_ATTR_MIME_TYPE		1 << SSH_FILEXFER_INDEX_MIME_TYPE
#define SSH_FILEXFER_ATTR_LINK_COUNT		1 << SSH_FILEXFER_INDEX_LINK_COUNT
#define SSH_FILEXFER_ATTR_UNTRANSLATED_NAME	1 << SSH_FILEXFER_INDEX_UNTRANSLATED_NAME
#define SSH_FILEXFER_ATTR_CTIME			1 << SSH_FILEXFER_INDEX_CTIME
#define SSH_FILEXFER_ATTR_CHANGETIME		SSH_FILEXFER_ATTR_CTIME
