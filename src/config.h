...
/* Define if Gio 2.0 is available */
#define HAVE_GIO2 1

/* Define if Glib 2.0 is available */
#define HAVE_GLIB2 1

/* Define if Gobject 2.0 is available */
#define HAVE_GOBJECT2 1
...
/* Define to 1 if you have the <linux/fuse.h> header file. */
#define HAVE_LINUX_FUSE_H 1
