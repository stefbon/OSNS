...
#define _OPTIONS_NETWORK_ENABLE_SFTP					1
...
#define _OPTIONS_SSH_FLAG_EXTINFO_GLOBAL_REQUEST			4 /* try first to check a new gobal request is supported by using extinfo for that */
...
#define _OPTIONS_SSH_EXTENSION_GR_SUPPORT				5
...
#define _OPTIONS_SSH_ENUMSERVICES_GLOBAL_REQUEST_SUPPORTED_UNKNOWN	0
#define _OPTIONS_SSH_ENUMSERVICES_GLOBAL_REQUEST_SUPPORTED_CLIENT	1
#define _OPTIONS_SSH_ENUMSERVICES_GLOBAL_REQUEST_SUPPORTED_SERVER	2

#define _OPTIONS_SSH_ENUMSERVICES_GLOBAL_REQUEST_DEFAULT		"enumservices@osns.net"
#define _OPTIONS_SSH_ENUMSERVICES_EXEC_DEFAULT				"/usr/lib/osns/enumservices"
#define _OPTIONS_SSH_ENUMSERVICES_FILE_DEFAULT				"/etc/osns/sftp.shares,.config/osns/sftp.shares"

#define _OPTIONS_SSH_ENUMSERVICES_ORDER_DEFAULT				"extinfo,exec,file"
